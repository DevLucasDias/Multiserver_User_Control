<div>
    <div>
        <div class="row">
            ...
            <div class="col s1">
                <button class="waves-effect waves-light btn modal-trigger" data-target="modalInserePabxUsers"
                href="#modalInserePabxUsers"><i class="fa fa-circle-plus" aria-hidden="true"></i></button>
            </div>
        </div>
        <div>
                ...
                @foreach ($pabxusuarios ?? '' as $data)
                    <tr>
                        ...
                        <td> <button class="waves-effect waves-light btn red"
                                ...
                                wire:click="deleteUnicoUsuario('{{ $data->id }}')"><i class="fa fa-trash"
    ...
    <div id="modalInserePabxUsers" class="modal">
